...
int preorder(AVLNode *root, int val, int *ur) {
    int key;
    ...
    if (root) {
      // printf("%d\n", );
        ...
        key = preorder(root->right, val, ur);
    }
